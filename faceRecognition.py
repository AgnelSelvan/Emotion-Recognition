...
def put_text(test_img, text, x, y, h, w):
    cv2.rectangle(test_img, (x, y+h), (x+w, y+h+30), (255, 0, 0), cv2.FILLED)
    cv2.putText(test_img, text, (x, y+h+20), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 1)
